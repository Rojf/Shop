...
class User(models.Model):
    order = models.OneToOneField(Order, related_name='user_details', on_delete=models.CASCADE)
...
class Delivery(models.Model):
    ...
    order = models.OneToOneField(Order, related_name='delivery_details', on_delete=models.CASCADE)
    ...
    delivery_type = models.CharField(
        max_length=1,
        choices=DeliveredType.choices,
        default=DeliveredType.COURIER
    )
